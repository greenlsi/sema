...
user_init (void)
{
    ...
    xTaskHandle t_ball, t_racket, t_screen;
    xTaskCreate (ball,   "ball",   1024, NULL, 1, &t_ball);
    xTaskCreate (racket, "racket", 1024, NULL, 2, &t_racket);
    xTaskCreate (screen, "screen", 1024, NULL, 3, &t_screen);
}
